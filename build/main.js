...
client.on('interactionCreate', (interaction) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        switch (interaction.options.getSubcommand()) {
            case 'now': {
                const nowSongP = (0, KiiteAPI_1.getAPI)('/api/cafe/now_playing');
                const cafeNowP = (0, KiiteAPI_1.getAPI)('/api/cafe/user_count');
                interaction.reply({
            ...
            case 'add': {
                ...
                if (args) {
                    ...
                    const pushList = yield (0, KiiteAPI_1.getAPI)('/api/songs/by_video_ids', { video_ids: args.join(',') });
            ...
            // }
            case 'list': {
                const pushList = yield (0, KiiteAPI_1.getAPI)('/api/songs/by_video_ids', { video_ids: notificList[interaction.user.id].songList.join(',') });
                if (pushList === null) {
                    return;
                }
                interaction.reply({
